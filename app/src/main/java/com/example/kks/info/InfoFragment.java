...
import com.example.kks.info.follow.FollowFragment;
...
public class InfoFragment extends Fragment {
    ...
    * */
    ...
    private Button liked_btn, withdrawal_btn;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        */
        ...
        following_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FollowFragment.follow_num = 0;//사용자를 팔로우 하는 List 띄워야 함
                LayoutInflater inflater1 = (LayoutInflater) root.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                inflater1.inflate(R.layout.fragment_follow, layout, true);
            }
        });
        ...
        follower_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FollowFragment.follow_num = 1;//사용자가 팔로우 하는 List 띄워야 함
                LayoutInflater inflater1 = (LayoutInflater) root.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                inflater1.inflate(R.layout.fragment_follow, layout, true);
            }
        });
